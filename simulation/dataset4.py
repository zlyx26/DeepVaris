...
def main():
    ...
    Lambda_list=[6,3,1.5,1,0.5]
    simulation_iterations = 5
    num_epochs_cnn = 50
    num_epochs_mask_list = [10,10,10,15,30]
    num_epochs_dnn = 10
    ...
    Epochs = 50
    dataset_file_name = f'dataset4_{samples_num}_{set_feature_num}'
    for Epoch in range(Epochs):
        ...
        if not os.path.exists(
            ...
            os.makedirs(
                f'results/{dataset_file_name}/{dataset_file_name}_{Epoch}_results/{dataset_file_name}_temp_{Epoch}/')
        train_X, train_Y, val_X, val_Y, test_X, test_Y, train_dataloader, val_dataloader, test_dataloader, train_samples_num, val_samples_num, test_samples_num, art, Mask_art, p0, feature_num, non_constant_features = generate_dataset_4(
